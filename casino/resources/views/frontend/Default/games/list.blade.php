                                        ...
                                        <div class="game-item__actions">
                                           ...
                                           @if(isset(auth()->user()->username))
                                                @if(auth()->user()->balance > 0)
                                                    <a href="{{ getGameRoute($game) }}" class="button button-primary ng-scope ng-binding">@lang('app.play_now')</a>
                                                @else
                                                ...
                                                @endif
                                                <br>
                                                <a href="{{ getGameRoute($game, true) }}" class="button button-primary ng-scope ng-binding">Demo</a>
                                            @else
                                                <a href="{{ getGameRoute($game, true) }}" class="button button-primary ng-scope ng-binding">Demo</a>
											<br>
