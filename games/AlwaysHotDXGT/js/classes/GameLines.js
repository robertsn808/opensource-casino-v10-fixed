...
objArr[objId+"_back"].lineStyle(14, cObj.back,1,1)
       .moveTo(cObj.segments[0].x, cObj.segments[0].y+0.2);
       
objArr[objId+"_front"].lineStyle(10, cObj.front_c,1,1)
...
objArr[objId].lineStyle(10, cObj.front_c,1,1)
       .moveTo(cObj.segments[0].x, cObj.segments[0].y);
...
objArr[objId+"_MASK"].drawRect(384, 0, 1251, 1024);
