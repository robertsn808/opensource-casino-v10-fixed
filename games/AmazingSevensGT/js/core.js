...
Preloader.outerCircle=PIXI.Sprite.fromImage('/games/AmazingSevensGT/source/LOADER/loading.png');
...
Preloader.innerCircleArr[i]=PIXI.Sprite.fromImage('/games/AmazingSevensGT/source/LOADER/progress'+i+'.png');
