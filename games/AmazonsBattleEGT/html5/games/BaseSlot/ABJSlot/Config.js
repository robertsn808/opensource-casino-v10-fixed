function Config()
{
    ...
    this.reelVideos = [
        ...
        {src:["images/videos/09-0.json", "images/videos/09-1.json", "images/videos/09-2.json", "images/videos/09-3.json"], fps: 18},
        {src:["images/videos/10-0.json", "images/videos/10-1.json", "images/videos/10-2.json", "images/videos/10-3.json"], fps: 18}];
    ...
    this.freespinSounds = [
        {
            ...
            {name: "freeSpinsBackgroundSound", start:24 , duration: 9.6}]
        }];
