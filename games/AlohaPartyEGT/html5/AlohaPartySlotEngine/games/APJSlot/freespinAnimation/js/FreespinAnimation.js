...
(function()
{
		...
		goToPhase: function(phase)
		{
			...
			switch(phase)
			{
				case "start":
					...
					this._introAnimation.addEventListener(CoreAnimation.FONT_LOADED, startVisualizationOnStartAnimation, this);
	...
	function startVisualizationOnStartAnimation(){
		this._startAnimation.startBlinkingVisualization();
	}
