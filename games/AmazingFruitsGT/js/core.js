...
Preloader.outerCircle=PIXI.Sprite.fromImage('/games/AmazingFruitsGT/source/LOADER/loading.png');
...
Preloader.innerCircleArr[i]=PIXI.Sprite.fromImage('/games/AmazingFruitsGT/source/LOADER/progress'+i+'.png');
