...
createjs.Sound.registerSound("/games/AlwaysHotCubesGTM/source/SOUND/"+slotSettings.slotSounds[i], sId);	
...
currentSound['FS'].volume=0;	
	...
	}else if(ev.detail.win<=200){
	
	currentSound['WIN_200']=PlaySound("WIN_200");	
	delayTime=currentSound['WIN_200'].duration;		
	}else if(ev.detail.win<=500){
	
	currentSound['WIN_500']=PlaySound("WIN_500");	
	delayTime=currentSound['WIN_500'].duration;		
	}
