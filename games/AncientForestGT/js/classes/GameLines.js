...
var cprop=libArr['lnWinSym_'+cSym];	
	...
	console.log(winArr[j][cPos]);
	
	winArr[j][cPos]._view.x-=32;
	winArr[j][cPos]._view.y-=70;
...
winArr[j][cPos]._view.y-=70;
	...
	borderArr[j].x=winArr[j][cPos]._view.x+objectsSettings['lnBorder'+0].offset+32;
	borderArr[j].y=winArr[j][cPos]._view.y+objectsSettings['lnBorder'+0].offset+70;
...
if(jType=='slotType1' || jType=='slotType0'){
