...
Preloader.outerCircle=PIXI.Sprite.fromImage('/games/AncientForestGT/source/LOADER/loading.png');
...
Preloader.innerCircleArr[i]=PIXI.Sprite.fromImage('/games/AncientForestGT/source/LOADER/progress'+i+'.png');
